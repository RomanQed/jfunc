...
public final class UniInterfacesTest {
    ...
    void uniRunnable0RunExceptionPropagation() {
        ...
        ExecutionException e = assertThrows(ExecutionException.class, () -> uni.runAsync().get());
    ...
    void uniFunction0InvokeExceptionPropagation() {
        ...
        ExecutionException e = assertThrows(ExecutionException.class, () -> uni.invokeAsync().get());
